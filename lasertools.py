        ...
        for layer in self.layers :
            if layer in self.selected_paths :                
                ...
                for path in self.selected_paths[layer]:
                    ...
                    print_("start csp transformation", time.strftime("%d.%m.%Y %H:%M:%S"))
                    csp = cubicsuperpath.parsePath(d)                  
                    csp = self.apply_transforms(path, csp)           
                    csp = csp_close_all_subpaths(csp)   
                    csp = self.transform_csp(csp, layer)
                    print_("finished csp transformation", time.strftime("%d.%m.%Y %H:%M:%S"))
                    ...
                    print_("calculating infill", time.strftime("%d.%m.%Y %H:%M:%S"))
                    ...
                    print_("finished calculating infill", time.strftime("%d.%m.%Y %H:%M:%S"))                
