...
lasertools_current_version = "0.9"
...
engraving_tolerance = 0.001
loft_lengths_tolerance = 0.000001

EMC_TOLERANCE_EQUAL = 0.0001
...
#					poly.draw(color = "Violet",width=4)					
	...
	def __init__(self):
		...
		self.OptionParser.add_option("",   "--engraving-sharp-angle-tollerance",action="store", type="float",	dest="engraving_sharp_angle_tollerance", default="180",		help="All angles thar are less than engraving-sharp-angle-tollerance will be thought sharp")		
		self.OptionParser.add_option("",   "--engraving-max-dist",			action="store", type="float", 		dest="engraving_max_dist", default="1000",					help="Distanse from original path where engraving is not needed (usualy it's cutting tool diameter)")		
		self.OptionParser.add_option("",   "--engraving-newton-iterations", action="store", type="int", 		dest="engraving_newton_iterations", default="2",			help="Number of sample points used to calculate distance")		
...
# xgettext:no-pango-format
	...
	def get_orientation_points(self,g):    		
		...
		if len(points)==2 or len(points)==3 : return points
		else : return None
	...
	def engraving(self) :
		...
		for layer in self.layers :
			if layer in self.selected_paths :
				...
				toolr=self.default_tool ['diameter'] * orientation_scale/2
				print_("tool radius in pixels=", toolr)
				#max dist from path to engrave in user's units
				max_distuu = min(self.default_tool ['diameter']/2, self.options.engraving_max_dist)
		...
		if gcode!='' :
			...
			#self.header+="(Depth, as a function of radius w, must be "+ toolshape + ")\n"
...
################################################################################
	def effect(self) :
		...
		if self.options.active_tab not in ['"dxfpoints"','"path-to-gcode"', '"area_fill"', '"area"', '"area_artefacts"', '"laserengraving"', '"orientation"', '"offset"', '"arrangement"', '"graffiti"']:
			...
			self.get_info()
			if self.options.active_tab in ['"dxfpoints"','"path-to-gcode"', '"area_fill"', '"area"', '"area_artefacts"', '"laserengraving"']:
				"""
