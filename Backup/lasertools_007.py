...
def csp_offset(csp, r) :
    offset_tolerance = 0.0005
    offset_subdivision_depth = 20
    time_ = time.time()
    time_start  = time_
...
################################################################################
    ...
    def apply_transforms(self,g,csp):
        ...
        if trans != []:
            trans[1][2] = 0
            print_('appliing Transformation')
            print_(trans)
        ...
        for layer in self.layers :
            if layer in self.selected_paths :                
                ...
                for path in self.selected_paths[layer]:
                    ...
                    #print_("Area transformed CSPs")
                    #print_(csp_line)              
                    csp_draw(csp_line, group = area_group)
